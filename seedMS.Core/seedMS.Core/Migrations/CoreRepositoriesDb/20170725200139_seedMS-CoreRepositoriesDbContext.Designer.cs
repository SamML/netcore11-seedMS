...
namespace seedMS.Core.Migrations.CoreRepositoriesDb
{
    [DbContext(typeof(CoreRepositoriesDbContext))]
    [Migration("20170725200139_seedMS-CoreRepositoriesDbContext")]
    partial class seedMSCoreRepositoriesDbContext
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("seedMS.Core.DomainModels.Repositories.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("seedMS.Core.DomainModels.Repositories.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("seedMS.Core.DomainModels.Repositories.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("seedMS.Core.DomainModels.Repositories.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("seedMS.Core.DomainModels.Repositories.Order", b =>
                {
                    b.HasOne("seedMS.Core.DomainModels.Repositories.ApplicationUser", "Cashier")
                        .WithMany("Orders")
